          ...
          {services.map((service, index) => {
            ...
            return (
                ...
                <CardContent className="p-4 md:p-6 flex flex-col h-full">
                  ...
                  {/* Description */}
                  <CardDescription className="text-gray-600 text-xs md:text-sm leading-relaxed mb-3 md:mb-4 flex-grow">
                    {service.description}
                  </CardDescription>
                  ...
                  <a 
                    ...
                    className="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium text-sm transition-all duration-300 mt-auto group-hover:translate-x-1"
                  >
                    Learn More
